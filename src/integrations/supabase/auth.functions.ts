...
const signUpSchema = z.object({
  email: z
    .string()
    .email()
    .refine((e) => e.endsWith("@gmail.com"), { message: "Email must be a @gmail.com address" }),
  password: z.string().min(10).regex(passwordRegex, {
    message:
      "Password must be at least 10 characters and include upper, lower, number, and special char",
  }),
