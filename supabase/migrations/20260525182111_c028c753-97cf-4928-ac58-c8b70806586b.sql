...
-- registrations
DROP POLICY IF EXISTS "regs_read_own_or_organizer" ON public.registrations;
...
DROP POLICY IF EXISTS "tasks_update_assigned_or_organizer" ON public.volunteer_tasks;
...
-- sponsorships
DROP POLICY IF EXISTS "sp_read_party" ON public.sponsorships;
...
DROP POLICY IF EXISTS "sp_insert_sponsor" ON public.sponsorships;
CREATE POLICY "sp_insert_sponsor" ON public.sponsorships FOR INSERT WITH CHECK (auth.uid()=sponsor_id);
DROP POLICY IF EXISTS "sp_update_party" ON public.sponsorships;
...
DROP POLICY IF EXISTS "cert_insert_organizer" ON public.certificates;
